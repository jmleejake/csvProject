...
public class JaikoPrdInfoVO {
	...
	public String toString() {
		return String.format(
				"JaikoPrdInfoVO [seq_id=%s, partner_id=%s, partner_nm=%s, prd_cd=%s, brand_nm=%s, prd_nm=%s, jan_cd=%s, prd_cnt=%s, prd_unit_prc=%s, dsku=%s, dasin=%s, tax_incld=%s, tax_rt=%s, reg_user_id=%s, reg_dt=%s, upd_user_id=%s, upd_dt=%s]",
				seq_id, partner_id, partner_nm, prd_cd, brand_nm, prd_nm, jan_cd, prd_cnt, prd_unit_prc, dsku, dasin,
				tax_incld, tax_rt, reg_user_id, reg_dt, upd_user_id, upd_dt);
	}
