...
public class RakutenVO {
	...
	public String toString() {
		return String.format(
				"RakutenVO [seq_id=%s, register_date=%s, update_date=%s, order_no=%s, order_status=%s, sub_status_id=%s, sub_status=%s, order_datetime=%s, order_date=%s, order_time=%s, cancel_due_date=%s, order_check_datetime=%s, order_confirm_datetime=%s, delivery_eta_datetime=%s, delivery_ata_datetime=%s, pay_method_name=%s, creadit_pay_method=%s, credit_pay_times=%s, delivery_method=%s, delivery_type=%s, order_type=%s, multi_destination_flag=%s, destination_match_flag=%s, island_flag=%s, rverify_flag=%s, warning_type=%s, rmember_flag=%s, purchase_hist_mod_flag=%s, total_goods_amt=%s, total_consume_tax=%s, total_shipping=%s, gross_deduction=%s, invoice_amt=%s, total_amt=%s, point_usage=%s, total_coupon_usage=%s, store_coupon_usage=%s, rakuten_coupon_usage=%s, order_post_no1=%s, order_post_no2=%s, order_add1=%s, order_add2=%s, order_add3=%s, order_surname=%s, order_name=%s, order_surname_kana=%s, order_name_kana=%s, order_tel1=%s, order_tel2=%s, order_tel3=%s, order_email=%s, order_sex=%s, request_no=%s, request_received_no=%s, ship_id=%s, ship_charge=%s, ship_substitute_fee=%s, ship_total_consume_tax=%s, ship_total_goods_amt=%s, ship_total_amt=%s, indicates=%s, delivery_post_no1=%s, delivery_post_no2=%s, delivery_add1=%s, delivery_add2=%s, delivery_add3=%s, delivery_surname=%s, delivery_name=%s, delivery_surname_kana=%s, delivery_name_kana=%s, delivery_tel1=%s, delivery_tel2=%s, delivery_tel3=%s, product_detail_id=%s, product_id=%s, product_name=%s, product_no=%s, product_manage_no=%s, unit_price=%s, unit_no=%s, delivery_cost_include=%s, tax_exclude=%s, substitute_fee_include=%s, product_option=%s, point_multiple=%s, delivery_info=%s, inventory_type=%s, wrap_title1=%s, wrap_name1=%s, wrap_amt1=%s, wrap_tax_include1=%s, wrap_type1=%s, wrap_title2=%s, wrap_name2=%s, wrap_amt2=%s, wrap_tax_include2=%s, wrap_type2=%s, delivery_time=%s, delivery_date_sel=%s, manager=%s, quick_note=%s, msg_to_customer=%s, gift_request=%s, comment=%s, util_terminal=%s, mail_carrier_code=%s, tomorrow_hope=%s, drug_order_flag=%s, rakuten_super_deal=%s, membership_program=%s, delivery_company=%s, baggage_claim_no=%s, trans_target_id=%s, result_text=%s, err_text=%s, start_date=%s, search_type=%s, seq_id_list=%s, attach_no=%s, real_seq_id=%s, fromDt=%s, toDt=%s]",
				seq_id, register_date, update_date, order_no, order_status, sub_status_id, sub_status, order_datetime,
				order_date, order_time, cancel_due_date, order_check_datetime, order_confirm_datetime,
				delivery_eta_datetime, delivery_ata_datetime, pay_method_name, creadit_pay_method, credit_pay_times,
				delivery_method, delivery_type, order_type, multi_destination_flag, destination_match_flag, island_flag,
				rverify_flag, warning_type, rmember_flag, purchase_hist_mod_flag, total_goods_amt, total_consume_tax,
				total_shipping, gross_deduction, invoice_amt, total_amt, point_usage, total_coupon_usage,
				store_coupon_usage, rakuten_coupon_usage, order_post_no1, order_post_no2, order_add1, order_add2,
				order_add3, order_surname, order_name, order_surname_kana, order_name_kana, order_tel1, order_tel2,
				order_tel3, order_email, order_sex, request_no, request_received_no, ship_id, ship_charge,
				ship_substitute_fee, ship_total_consume_tax, ship_total_goods_amt, ship_total_amt, indicates,
				delivery_post_no1, delivery_post_no2, delivery_add1, delivery_add2, delivery_add3, delivery_surname,
				delivery_name, delivery_surname_kana, delivery_name_kana, delivery_tel1, delivery_tel2, delivery_tel3,
				product_detail_id, product_id, product_name, product_no, product_manage_no, unit_price, unit_no,
				delivery_cost_include, tax_exclude, substitute_fee_include, product_option, point_multiple,
				delivery_info, inventory_type, wrap_title1, wrap_name1, wrap_amt1, wrap_tax_include1, wrap_type1,
				wrap_title2, wrap_name2, wrap_amt2, wrap_tax_include2, wrap_type2, delivery_time, delivery_date_sel,
				manager, quick_note, msg_to_customer, gift_request, comment, util_terminal, mail_carrier_code,
				tomorrow_hope, drug_order_flag, rakuten_super_deal, membership_program, delivery_company,
				baggage_claim_no, trans_target_id, result_text, err_text, start_date, search_type, seq_id_list,
				attach_no, real_seq_id, fromDt, toDt);
	}
